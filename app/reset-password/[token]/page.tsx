...
export default function ResetPassword() {
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto my-10">
            <Link href="/">
                <button className="text-lg my-2 flex mx-4 items-center justify-center rounded-xl relative  py-2 h-[52px] border border-accent text-white duration-200 overflow-hidden z-50 font-semibold px-3 pr-4">
            ...
            <div className="flex min-h-[80vh] items-center justify-center">
                <div className="text-sm max-w-lg mx-auto w-full shadow-2xl rounded px-4 py-6">
                    ...
                    <button onClick={handleResetPassword} type="submit" className="text-lg my-3 flex items-center justify-center rounded-xl relative  py-2 h-[52px] w-full bg-rose-500 hover:bg-rose-400 text-white duration-200 overflow-hidden active:bg-rose-400 z-50 font-semibold">
                        {
                            isLoading ?
