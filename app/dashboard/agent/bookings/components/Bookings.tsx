...
const Bookings = () => {
    ...
    return (
        <div className='bg-primary-50 text-secondary-50 min-h-screen'>
                        ...
                        {bookings?.slice()?.reverse()?.map((booking: booking, id: number | string) => (
                            ...
                            >
                                <div className='flex'>
                                    ...
                                    <div className='pl-4 flex items-center font-semibold'>
                                        <p>{user?.name}</p>
                                    </div>
                                </div>
            ...
            {
                bookings?.length < 1 && <div className="text-center mt-20 text-white"><h1 className="lg:text-4xl text-2xl text-center">You haven't any Booking yet. Please booking Property</h1></div>
            }
        </div>
    );
};
