                ...
                <div className="grid grid-cols-2 mt-5 gap-5">
                    ...
                    <div
                        ...
                        <div className="flex  items-center gap-2 text-white px-2 lg:px-5 ">
                            ...
                            <div className="">
                                <div className="leading-[111%]">{format(searchCalDate[0].startDate, "MMM dd, yyyy")}</div>
                                <div className="leading-[111%]">{format(searchCalDate[0].startDate, "EEEE")}</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-white px-2 lg:px-5  relative">
                            <Image src="/icons/bookingIcon.svg" height={24} width={24} alt="img" />
                            <div>
                                <div className="leading-[111%]">{format(searchCalDate[0].endDate, "MMM dd, yyyy")}</div>
                                <div className="leading-[111%]">{format(searchCalDate[0].endDate, "EEEE")}</div>
                            </div>
                            {/* Down Arrow Button */}
                            <FaChevronDown className={`absolute ${heroStyles.downArrow} right-4 text-2xl`} />
                        </div>
